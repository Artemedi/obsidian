...
Я выбрал один из столбцов, по которому хочу сгруппировать данные, в данном случае искусственный столбец [QueryText]. Таблица в окне Live Data Explorer немедленно обновится. Она группируется на основе выбранного столбца или столбцов, как показано на рис. 3-27.